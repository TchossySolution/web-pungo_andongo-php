...
if (isset($_POST['send_comments'])) {
  ...
  if (empty(trim($user_id))) {
    echo "<script>
              ...
              window.location.href='https://jornalpungoandongo.ao/news/detailsNews/$news_id';
            </script>";
    exit();
  }
  if (empty(trim($news_id))) {
    echo "<script>
              ...
              window.location.href='https://jornalpungoandongo.ao/news/1';
            </script>";
    exit();
  }
...
if (isset($_POST['update_comments'])) {
  ...
  if ($sql->execute(array($status, $date_update, $id))) {
    echo "<script>
            ...
            window.location.href='https://jornalpungoandongo.ao/dashboard/comments';
          </script>";
  } else {
    header('Location: https://jornalpungoandongo.ao/ops/nn');
  };
...
if (isset($_POST['delete_comments'])) {
  ...
  if ($sql->execute(array($id))) {
    ...
    echo "<script>
              window.location.href='https://jornalpungoandongo.ao/dashboard/ops/nn';
            </script>";
  };
};