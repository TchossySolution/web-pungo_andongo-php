          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" enctype="multipart/form-data"
                ...
                <input type="text" value="<?= $data['description_news']; ?>" class="form-control"
                  name="description_news" placeholder="Digite a descrição  da Noticia" require>
                <br>
                ...
                <input type="text" value="<?= $data['photography_news']; ?>" class="form-control"
                  name="photography_news" placeholder="Digite o nome do fotografo" require>
                <br>
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" name="update_news">Atualizar Noticia</button>
                </div>
              </form>
            </div>
          </div>
