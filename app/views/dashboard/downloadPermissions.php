    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="post" action="<?= urlProject(CONTROLLERS . "/downloadPermissionsController.php") ?>">
            <div>
              <label>E-mail: </label>
              <input type="email" class="form-control" name="email_permissions" placeholder="Digite o nome do Autor"
                require>
              <br>

              <label>Tipo de permissão: </label>
              <select class="form-control" name="type_permissions" id="" require>
                <option value="days">Diário</option>
                <option value="month">Mensal</option>
                <option value="year">Anuário</option>
              </select>
              <br>

              <label>Tempo de permissão: </label>
              <input type="number" class="form-control" name="time_permissions" value="1" placeholder="Tempo" require>

            </div>

            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
              <button type="submit" class="btn btn-primary" name="add_downloadPermissions">Adicionar permissão</button>
            </div>
          </form>
